...
| T17/P0 | 设计说明新业务流程与阶段计划 | 用户新讨论、Figma 初稿、现有代码 | `docs/PRD.md`、`docs/IMPLEMENTATION_PLAN.md`、接续记录 | 桌面 PRD 更新 | 三步流程、标准库/副本、自动保存、Word 输出、范围和验收可核对 | 待验收（文档评审稿；Figma 当前画面未直接复核） |
