...
> 历史验收操作指南。2026-09-26 用户已签收真实位置安装、升级、卸载；见本文末尾签收记录。
...
用户确认此前真实位置的图形化安装、升级、卸载及 CAD 使用检查通过，要求 T13 登记验收通过并合并。此前 `测试结果/0925/安装过程2/`、T13 日志和沙箱安装/卸载检查作为已有证据；本轮最终包继续做构建和清单校验。全新电脑、断网安装及回滚演练没有独立实测记录，按用户明确决定免作本阶段额外关卡，不写成已实测。
